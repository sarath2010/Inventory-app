            ...
            <form>
                ...
                {mode_of_adjustment === "Quantity" && (
                    <>
                        ...
                        <input type="text" placeholder='Enter new stock' onChange={(e) => { setQuantity(e.target.value) }} value={quantity} />
                    </>
                )}
                ...
                {mode_of_adjustment === "Value" && (
                    <>
                        ...
                        <input type="text" placeholder='Enter new price' onChange={(e) => { setValue(e.target.value) }} value={value} />
                    </>
                )}
                ...
                <button onClick={(e) => { makeAdjust(e) }}>Apply</button>
            </form>
        </>
    )
}
